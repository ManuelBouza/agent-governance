...
The effort recommendation and execution-shape classification do not themselves authorize the next objective. Human selection, D067 lifecycle rules and all existing task/stage gates remain controlling.
