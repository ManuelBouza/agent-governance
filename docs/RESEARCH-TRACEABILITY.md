...
| R027 | `docs/research/R027-CHATGPT-CODEX-COST-EFFICIENT-RESPONSIBILITY-SPLIT.md` | COMPLETE | EVALUATING | D053/D054/D055/D060/D065/D068/D075/D076; current OpenAI Chat/Work/Codex, prompting, AGENTS.md, subagent, speed and rate-card guidance; OpenAI Harness Engineering; Lulla 2026; Gloaguen 2026; Terminus-4B; FastContext | none | R027 recommends a candidate split where ChatGPT retains semantic/governance authority while Codex owns normal repo-local technical materialization and verification, with compact instructions, Standard speed, progressive compute/verification, and ROI-gated cheap specialists. Exact D068/D055/delegation/Markdown changes require prospective qualification before adoption. |
