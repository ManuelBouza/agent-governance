...
Last-Registry-Review: 2026-09-17
...
| R032 | `docs/research/R032-CODEX-MODEL-EFFORT-SELECTION.md` | COMPLETE | DECIDED | D055; R007/T063; R010; current OpenAI model/reasoning guidance; Codex stable/prerelease revalidation; no new provider trial | `docs/decisions/D083-codex-model-effort-selection-classifier.md` | D083 adopts the conservative pre-launch classifier based on authority completeness, execution determinism, technical branching, verification strength and concrete risk. Model capability and reasoning effort are independent escalation axes. Sol/Medium remains the safe fallback; bounded Terra/Luna downshift is permitted only when the explicit gates support it. |
