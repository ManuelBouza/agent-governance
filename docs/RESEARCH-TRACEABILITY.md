...
| R007 | `docs/research/ADAPTIVE-SUBAGENT-COMPUTE-ROUTING-RESEARCH.md` | COMPLETE | EVALUATING | `docs/tasks/T054-adaptive-subagent-compute-routing-pilot.md`; `docs/reviews/T054-R1.md`; D063; `docs/tasks/T063-adaptive-worker-routing-requalification.md`; R018; R019; R020; R021; R022; `docs/reviews/T063-R7.md` | none | T054 was accepted but `NOT_QUALIFIED`. T063 v1/v2/v3 all blocked without a pilot decision. V3 proved the Desktop-bundled 0.153.4 runtime but hit the empty-rollout reattach race before any valid scored child. R022/R7 accept that evidence and authorize a clean v4 candidate with a bounded same-child reattach persistence barrier while preserving D063 and the frozen experiment. No global adaptive worker-routing policy is adopted. |
...
| R022 | `docs/research/R022-T063-V3-EMPTY-ROLLOUT-REATTACH-RACE.md` | COMPLETE | NOT_REQUIRED | v3 terminal HEAD `746519abc6f159e959120f68d5c9f920d88d5797`; v4 candidate `89da4d5b5fbeeb32e6dcf4dd4fde7839f043dfa5`; `docs/reviews/T063-R7.md`; official Codex `0.153.4`, `0.154.0`, `0.155.0-alpha.2` and current-main source | none | V3 blocked after one invalid/unscored P1 ADAPTIVE child because `subAgentActivity Started` can precede durability of rollout metadata required by immediate `thread/resume`. Higher reviewed versions preserve the same path, so D077 remains `PIN_RETAINED`. V4 adds only a bounded same-child reattach persistence barrier with parent-residency rechecks and no extra provider/model turn. |
...
R022 — T063 v3 empty-rollout reattach race
  ...
  v3 scored provider attempts consumed: 1 child / 1 parent
  valid v3 scored children: 0
  cause: Started-to-rollout-metadata persistence race at thread/resume
  Desktop effective runtime proven: 0.153.4
  versions reviewed: 0.153.4 / 0.154.0 / 0.155.0-alpha.2 / main
  version disposition: PIN_RETAINED
  v4 candidate HEAD: 89da4d5b5fbeeb32e6dcf4dd4fde7839f043dfa5
  v4 repair: bounded same-child reattach persistence barrier
...
R007 — adaptive subagent compute routing
  ...
  next T063 step: NEW root-4 provider-free Stage 6 gates, then clean six-arm v4 execution if all gates pass
```
...
R022 — T063 v3 reattach-race diagnosis / v4 adapter repair
  COMPLETE / NOT_REQUIRED
```
