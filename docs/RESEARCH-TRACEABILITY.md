...
| R032 | `docs/research/R032-CODEX-MODEL-EFFORT-SELECTION.md` | COMPLETE | EVALUATING | D055; R007/T063; R010; D077 revalidation on 2026-09-17; proposed D083 | `docs/decisions/D083-adaptive-executor-model-effort-selection.md` (PROPOSED) | R032 refines D055's minimum-sufficient-compute principle into an explicit classifier using authority completeness, execution determinism, technical branching, verification strength and concrete risk modifiers. Model family and reasoning effort remain independent axes. No global Terra/Luna replacement is qualified; Sol/Medium remains the safe fallback pending normative adoption and project evidence. |
