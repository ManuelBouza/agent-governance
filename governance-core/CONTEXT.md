...
- **T2 Focused context** — only the applicable lifecycle/SDD/coexistence/quality module, current task, exact referenced project-native artifact, Skill, mission context or decision needed now.
...
STATE answers: where are we, what controls the frontier, and what can happen next. Do not store full task inventories, capability inventories, external SDD inventories, specification history, decision history, debate, logs or repeated MISSION/WORKPLAN content.
