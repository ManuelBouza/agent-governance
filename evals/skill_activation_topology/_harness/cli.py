"""Command-line interface for the frozen T023 v15 topology harness."""
        ...
        json.dumps(
            {
                ...
                "base_scheduled_trials": len(scheduled_trials(inputs)),
                "maximum_trial_identities": len(all_possible_trials(inputs)),
            },
            sort_keys=True,
        )
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    materialize.add_argument("--candidate", required=True, choices=("B2", "F2", "G3"))
    ...
    run.add_argument("--candidate", action="append", choices=("B2", "F2", "G3"))
