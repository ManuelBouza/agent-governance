...
def validate_execution_config(inputs: FrozenInputs, args: argparse.Namespace) -> None:
    ...
    if len(all_possible_trials(inputs)) != method["global_max_valid_observations"]:
        raise HarnessError(
            "v15 maximum identity set does not match the frozen 630-observation budget"
        )
...
def _initial_metadata(
    ...
    return {
        ...
        "candidate_round_robin_order": inputs.oracle["scheduling"]["candidate_round_robin_order"],
