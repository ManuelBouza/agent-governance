"""Minimal stdlib JSON-RPC client for the Codex 0.153.4 App Server.

This module is Stage-5 materialized infrastructure for T063.  It intentionally
implements only the protocol mechanics needed by the frozen evaluation.
"""
...
class AppServerClient:
    ...
    def initialize(self) -> Json:
        result = self.request(
            ...
            {
                "clientInfo": {
                    "name": "agent-governance-t063",
                    "title": "Agent Governance T063 Harness",
                    "version": "1",
                },
